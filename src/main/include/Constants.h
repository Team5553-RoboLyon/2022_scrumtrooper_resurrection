...
// Winch
constexpr int WINCH_MOTOR = 5;//TOpas la ?
...
// TelescopicArm
constexpr int TELESCOPIC_ARM_MOTOR = 0;//TODO c'est pas présent
...
// Turret
constexpr int TURRET_ENCODER= 9;
...
constexpr int TURRET_RELAY = 20;//TODO pas la ?

// ############### PCM IDs ###############
// Intake
constexpr int INTAKE_SOLENOID_A = 0;
constexpr int INTAKE_SOLENOID_B = 1;
